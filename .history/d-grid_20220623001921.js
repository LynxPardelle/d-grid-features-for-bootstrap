    ...
    for (let gridElement of gridElements) {
      ...
      for (let attribute of gridElement.attributes) {
        ...
        if (at.includes("gfbs-")) {
          ...
          let aCrClMessage;
          let cssRules = sheets.map((s) => [...s.cssRules].reverse());
          for (let cssRule of cssRules) {
            for (let rule of cssRule) {
              // attValue = attValue.replace(/\n/g, "").replace(/\s\s/g, "");
              if (gfb.includes("gt") && rule.cssText.includes("grid-template")) {
                if (
                  rule.cssText.includes(
                    attValue.replace(/\n/g, "").replace(/\s\s/g, "").replace(/"end][row"/g,"end row")
                  )
                ) {
          ...
          switch (property) {
            ...
            case "custom":
              ...
              break;
            case "gtc":
              gfbStringed += `{grid-template-columns:${attValue};}`;
              break;
            case "gtr":
              gfbStringed += `{grid-template-rows:${attValue};}`;
              break;
            case "gta":
            ...
            case "cg":
              ...
              break;
            case "rg":
              gfbStringed += `{row-gap:${attValue};}`;
              break;
            case "gap":
              gfbStringed += `{gap:${attValue};}`;
              break;
            case "ji":
              gfbStringed += `{justify-items:${attValue};}`;
              break;
            case "ai":
              gfbStringed += `{align-items:${attValue};}`;
              break;
            case "pi":
              gfbStringed += `{place-items:${attValue};}`;
              break;
            case "jc":
              gfbStringed += `{justify-content:${attValue};}`;
              break;
            case "ac":
              gfbStringed += `{align-content:${attValue};}`;
              break;
            case "pc":
              gfbStringed += `{place-content:${attValue};}`;
              break;
            case "gac":
              gfbStringed += `{grid-auto-columns:${attValue};}`;
              break;
            case "gar":
              gfbStringed += `{grid-auto-rows:${attValue};}`;
              break;
            case "gaf":
              gfbStringed += `{grid-auto-flow:${attValue};}`;
              break;
            case "grid":
            ...
            // Item
            case "gcs":
              gfbStringed += `{grid-column-start:${attValue};}`;
              break;
            case "gce":
              gfbStringed += `{grid-column-end:${attValue};}`;
              break;
            case "gc":
              gfbStringed += `{grid-column:${attValue};}`;
              break;
            case "grs":
              gfbStringed += `{grid-row-start:${attValue};}`;
              break;
            case "gre":
              gfbStringed += `{grid-row-end:${attValue};}`;
              break;
            case "gr":
              gfbStringed += `{grid-row:${attValue};}`;
              break;
            case "iga":
              gfbStringed += `{grid-area:${attValue};}`;
              break;
            case "js":
              gfbStringed += `{justify-self:${attValue};}`;
              break;
            case "as":
              gfbStringed += `{align-self:${attValue};}`;
              break;
            case "ps":
              gfbStringed += `{place-self:${attValue};}`;
              break;
          }
