function CreateNewGridSample() {
  ...
  const sectionOptions = [
    ...
    <section
      ...
      >
  `,
    `<section class="d-grid bg-dark w-75 mx-auto my-4" data-gfbs data-gfbs-gtc="repeat(4, 1fr)" data-gfbs-gtr="repeat(2, 50px)" >`,
    `<section class="d-grid bg-light w-75 mx-auto my-4" data-gfbs data-gfbs-gta='"f f b c c a"" f f d e e a"'>`,
  ];
