...
document.getElementById("console").innerHTML += 'gridElements= ' + gridElements.toString() + '<br />';
...
document.getElementById("console").innerHTML += 'attribute= ' + attribute.toString() + '<br/>';
