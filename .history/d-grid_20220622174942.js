    ...
    for (let gridElement of gridElements) {
      ...
      for (let attribute of gridElement.attributes) {
        ...
        if (at.includes("gfbs-")) {
          ...
          newClasses.push(`${gfb}-${newRandomClassName}DIVISOR${attValue}`);
          ...
          if (gfbStringed.includes("{") && gfbStringed.includes("}")) {
            if (hasBP === true) {
              ...
              switch (gfbsSplited[2]) {
                case "sm":
                  gfbStringedSM += gfbStringed;
                  break;
                case "md":
                  gfbStringedMD += gfbStringed;
                  break;
                case "lg":
                  gfbStringedLG += gfbStringed;
                  break;
                case "xl":
                  gfbStringedXl += gfbStringed;
                  break;
                case "xxl":
                  gfbStringedXXL += gfbStringed;
                  break;
              }
            } else {
              gfbStringed += gfbStringed + "/";
            }
          }
        }
      }
