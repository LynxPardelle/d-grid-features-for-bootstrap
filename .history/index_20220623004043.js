function CreateNewGridSample() {
  ...
  `,
    ...
    `<section class="d-grid bg-dark" data-gfbs data-gfbs-gta='"f f b c c a"" f f d e e a"'>`,
  ];

  gridContainer.innerHTML += `
  ${sectionOptions[cNGSIterator]}
        <!-- data-gfbs-cg="1rem"
        data-gfbs-rg="1rem" -->
        <div
          data-gfbs
  ...
  `;
  if (cNGSIterator < sectionOptions.length) {
    console.log(cNGSIterator);
    cNGSIterator++;
  } else {
    console.log(cNGSIterator);
    cNGSIterator = 0;
